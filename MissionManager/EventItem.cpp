...
void EventItem::SetEventType(int nType)
{
	...
	else if (nType == 1) m_eType = EVENT_RANDOM;
	else if (nType == 2) m_eType = EVENT_INPUTTEXT;
	else if (nType == 3) m_eType = EVENT_SHIELD;
	else if (nType == 4) m_eType = EVENT_SPEAKDIRECTLY;
}
